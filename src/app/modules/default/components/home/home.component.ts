...
export class HomeComponent implements OnInit {
  ...
  heroTitle: string = 'Enjoy an incredible <span class="text-secondary-color">learning</span> experience'
  ...
  testimonials = [
    {
      ...
      description: 'The more you use Dumena Tech LMS, the clearer it becomes that its total quality and efficiency exceed any of its particular capabilities.',
  ...
  news = [
    {
      ...
      details: 'It’s one thing to enroll your child in school and the its another thing to be able to track and monitor he/her progress.',
      url: ''
    },
    {
      id: 2,
    ...
    },
    {
      ...
      details: 'It’s one thing to enroll your child in school and the its another thing to be able to track and monitor he/ to go to in.',
      url: ''
    }
  ]
